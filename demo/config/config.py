...
config.dataset.proposal_prefix = ''
...
config.dataset.NUM_SUB_CLASSES = 194
config.dataset.proposal = 'rpn'
config.dataset.class_matching_file = ''
...
# [Index] - [Class name] matching (for visualization)
config.VIS = edict()

config.VIS.index2word = ""
config.VIS.output = ""
config.VIS.thresh = 0.5
