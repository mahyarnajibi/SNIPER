...
#config.SCALES = [(1400, 2000), (800, 1200), (480, 800)]  # first is scale (the shorter side); second is max size
config.SCALES = [(1400, 2000), (720, 1280), (480, 800)]
config.startMSTR = 4
config.prop_dir = 'r50ep3'
# default training
config.default = edict()
config.default.frequent = 20
config.default.kvstore = 'device'
config.RPNONLY = False
config.mstr = False
config.IS_DPN = False
...
config.TRAIN.ENABLE_FOCALLLOSS = False
