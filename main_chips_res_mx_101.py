...
from symbols.faster.resnet_mx_101 import resnet_mx_101, checkpoint_callback
...
def parser():
    ...
    arg_parser.add_argument('--cfg',dest='cfg',help='Path to the config file',
                        default='configs/faster/res101_mx.yml',type=str)                             
...
if __name__=='__main__':
    ...
    sym_inst = resnet_mx_101(n_proposals=400,momentum=args.momentum, fix_bn=False)
