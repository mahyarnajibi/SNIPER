import os
import init
from iterators.MNIteratorChipsNeg import MNIteratorChips
...
def parser():
	...
	arg_parser.add_argument('--cfg',dest='cfg',help='Path to the config file',
						default='configs/faster/res50_real_ms_fast_neg_chips.yml',type=str) 
...
if __name__=='__main__':
	...
	mod.fit(train_iter,optimizer='sgd',optimizer_params=optimizer_params,
			...
			epoch_end_callback=epoch_end_callback, arg_params=arg_params,aux_params=aux_params,prefix='chip_neg')
